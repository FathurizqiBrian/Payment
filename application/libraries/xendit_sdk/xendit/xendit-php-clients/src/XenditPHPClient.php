<?php
    ...
    class XenditPHPClient {
        ...
        function createInvoice ($external_id, $amount, $payer_email, $description, $success_redirect_url, $should_send_email, $invoice_options = null) {
            $curl = curl_init();
            ...
            $data['should_send_email'] = $should_send_email;
